    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          30.height,
          Text(lbl_about_this_quiz, style: boldTextStyle(size: 20)).paddingOnly(left: 16, right: 16),
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(lbl_quiz_title, style: boldTextStyle()),
                8.height,
                ...
                Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(lbl_quiz_duration, style: boldTextStyle()),
                    4.width,
