...
class RegisterScreenState extends State<RegisterScreen> {
  ...
  signUp() async {
    if (formKey.currentState!.validate()) {
      ...
      await authService.signUpWithEmailPassword(name: nameController.text, email: emailController.text, password: passController.text.validate(), age: dropdownValue).then((value) {
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(lbl_sign_up, style: boldTextStyle(color: white, size: 30)),
                          8.height,
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(lbl_already_have_an_account, style: primaryTextStyle(color: white)),
                              4.width,
                              Text(lbl_sign_in, style: boldTextStyle(color: white)).onTap(() {
                                finish(context);
                              }),
                            ],
                          )
                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      30.height,
                      gradientButton(text: lbl_sign_up, onTap: signUp, isFullWidth: true, context: context),
                    ],
